...
class VaDepositTransactionsResponse(object):
    ...
    def ra_branch_name_kana(self):
        ...
        入金口座　支店名カナ<br>半角文字<br>  # noqa: E501
    ...
    def ra_holder_name(self):
        ...
        入金口座　口座名義（漢字）<br>全角文字<br>  # noqa: E501
    ...
    def base_date(self):
        ...
        基準日<br>半角文字<br>入金明細を照会した基準日を示します<br>YYYY-MM-DD形式<br>  # noqa: E501
    ...
    def base_time(self):
        ...
        基準時刻<br>半角文字<br>入金明細を照会した基準時刻を示します<br>HH:MM:SS+09:00形式<br>  # noqa: E501
    ...
    def va_transactions(self):
        ...
        振込入金口座入金明細情報リスト<br>該当する情報が無い場合は、空のリストを返却します<br>  # noqa: E501
