...
class AccountsResponse(object):
    ...
    def __init__(self, base_date=None, base_time=None, accounts=None):  # noqa: E501
    ...
    @property
    def base_date(self):
        """Gets the base_date of this AccountsResponse.  # noqa: E501

        基準日<br>半角文字<br>一覧照会の基準日を示します<br>YYYY-MM-DD形式<br>  # noqa: E501

        :return: The base_date of this AccountsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def base_date(self, base_date):
        """Sets the base_date of this AccountsResponse.

        基準日<br>半角文字<br>一覧照会の基準日を示します<br>YYYY-MM-DD形式<br>  # noqa: E501

        :param base_date: The base_date of this AccountsResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def base_time(self):
        """Gets the base_time of this AccountsResponse.  # noqa: E501

        基準時刻<br>半角文字<br>一覧照会の基準時刻を示します<br>HH:MM:SS+09:00形式<br>  # noqa: E501

        :return: The base_time of this AccountsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def base_time(self, base_time):
        """Sets the base_time of this AccountsResponse.

        基準時刻<br>半角文字<br>一覧照会の基準時刻を示します<br>HH:MM:SS+09:00形式<br>  # noqa: E501

        :param base_time: The base_time of this AccountsResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def accounts(self):
        """Gets the accounts of this AccountsResponse.  # noqa: E501

        口座情報リスト<br>  # noqa: E501

        :return: The accounts of this AccountsResponse.  # noqa: E501
        :rtype: list[Account]
        """
    ...
    def accounts(self, accounts):
        """Sets the accounts of this AccountsResponse.

        口座情報リスト<br>  # noqa: E501

        :param accounts: The accounts of this AccountsResponse.  # noqa: E501
        :type: list[Account]
        """
        if accounts is None:
