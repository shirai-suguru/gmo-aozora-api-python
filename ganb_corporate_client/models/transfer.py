...
class Transfer(object):
    ...
    def item_id(self):
        ...
        明細番号<br>半角数字<br>重複/0はエラー　1～99の範囲で１からの連番とします<br>1件のみの場合は省略可（項目自体の設定が不要です）<br>  # noqa: E501
    ...
    def beneficiary_name(self):
        ...
        受取人名<br>半角文字<br>振込許容文字を指定可<br>ただし、一部の非許容文字は、許容文字に変換を行います<br>  # noqa: E501
