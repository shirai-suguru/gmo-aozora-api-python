...
class BulkTransfer(object):
    ...
    def item_id(self):
        ...
        明細番号<br>半角数字<br>重複/0はエラー　1～9999の範囲で１からの連番とします<br>  # noqa: E501
    ...
    def beneficiary_bank_name(self):
        ...
        被仕向金融機関名カナ<br>半角文字<br>参考値、処理に利用しません<br>  # noqa: E501
    ...
    def beneficiary_branch_name(self):
        ...
        被仕向支店名カナ<br>半角文字<br>参考値、処理に利用しません<br>  # noqa: E501
    ...
    def clearing_house_name(self):
        ...
        手形交換所番号<br>半角文字<br>入力する場合は、ALL０,ALLスペースであること<br>参考値、処理に利用しません<br>  # noqa: E501
    ...
    def beneficiary_name(self):
        ...
        受取人名<br>半角文字<br>振込許容文字を指定可<br>ただし、一部の非許容文字は、許容文字に変換を行います<br>30文字目まで有効（31文字目以降は切り捨てます）<br>  # noqa: E501
    ...
    def transfer_amount(self):
        ...
        振込金額<br>半角数字<br>1以上9,999,999,999円以下　数値のみでカンマ、マイナス不可<br>  # noqa: E501
    ...
    def new_code(self):
        ...
        新規コード<br>半角文字<br>入力する場合は、数値またはスペースであること<br>参考値、処理に利用しません<br>  # noqa: E501
    ...
    def edi_info(self):
        ...
        EDI情報<br>半角文字<br>振込許容文字を指定可<br>  # noqa: E501
    ...
    def transfer_designated_type(self):
        ...
        振込指定区分<br>半角文字<br>入力する場合は、7：電信のみ　またはスペースであること<br>参考値、処理に利用しません（入力にかかわらず、すべて7：電信扱いとなります）<br>  # noqa: E501
    ...
    def identification(self):
        ...
        識別表示<br>半角文字<br>本項目が「Y」であればEDI情報は振込先に通知、または省略/NULL/スペースであれば振込先には通知しません<br>  # noqa: E501
