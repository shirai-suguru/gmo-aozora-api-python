...
class TransferCancelRequest(object):
    ...
    def cancel_target_key_class(self):
        ...
        取消対象キー区分<br>半角英数値<br>取消対象の取引の内容について指定します<br>1:振込申請取消　2:振込受付取消　3:総合振込申請取消　4:総合振込受付取消<br>取消対象キー区分と、取消対象の振込申請番号の状態がマッチしない場合は、「400 Bad Request」を返却<br>  # noqa: E501
    ...
    def apply_no(self):
        ...
        受付番号（振込申請番号）<br>半角数字<br>取り消し対象の番号を設定<br>  # noqa: E501
