...
class VaStatusChangeResponse(object):
    ...
    def __init__(self, v_accounts=None):  # noqa: E501
        """VaStatusChangeResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def v_accounts(self):
        """Gets the v_accounts of this VaStatusChangeResponse.  # noqa: E501

        振込入金口座情報<br>振込入金口座情報のリスト  # noqa: E501

        :return: The v_accounts of this VaStatusChangeResponse.  # noqa: E501
        :rtype: list[VAccount]
        """
    ...
    def v_accounts(self, v_accounts):
        """Sets the v_accounts of this VaStatusChangeResponse.

        振込入金口座情報<br>振込入金口座情報のリスト  # noqa: E501

        :param v_accounts: The v_accounts of this VaStatusChangeResponse.  # noqa: E501
        :type: list[VAccount]
        """
        if v_accounts is None:
            raise ValueError("Invalid value for `v_accounts`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VaStatusChangeResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VaStatusChangeResponse):
            return False
