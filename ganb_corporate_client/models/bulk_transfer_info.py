...
class BulkTransferInfo(object):
    ...
    def item_id(self):
        ...
        明細番号<br>半角数字<br>重複/0はエラー　1～9999とします<br>  # noqa: E501
    ...
    def beneficiary_bank_name(self):
        ...
        被仕向金融機関名カナ<br>半角文字<br>該当する情報が無い場合は項目自体を設定しません<br>  # noqa: E501
    ...
    def beneficiary_branch_name(self):
        ...
        被仕向支店名カナ<br>半角文字<br>該当する情報が無い場合は項目自体を設定しません<br>  # noqa: E501
    ...
    def clearing_house_name(self):
        ...
        手形交換所番号<br>半角文字<br>該当する情報が無い場合は項目自体を設定しません<br>  # noqa: E501
    ...
    def new_code(self):
        ...
        新規コード<br>半角文字<br>該当する情報が無い場合は項目自体を設定しません<br>  # noqa: E501
    ...
    def transfer_designated_type(self):
        ...
        振込指定区分<br>半角文字<br>該当する情報が無い場合は項目自体を設定しません<br>  # noqa: E501
    ...
    def identification(self):
        ...
        識別表示<br>半角文字<br>該当する情報が無い場合は項目自体を設定しません<br>  # noqa: E501
