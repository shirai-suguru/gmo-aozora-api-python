...
class VaCloseRequestResponse(object):
    ...
    def __init__(self, accept_date=None):  # noqa: E501
        """VaCloseRequestResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def accept_date(self):
        """Gets the accept_date of this VaCloseRequestResponse.  # noqa: E501

        解約申込受付日<br>半角文字<br>解約申込を受け付けた日付を示します<br>YYYY-MM-DD形式<br>  # noqa: E501

        :return: The accept_date of this VaCloseRequestResponse.  # noqa: E501
        :rtype: str
        """
        return self._accept_date

    @accept_date.setter
    def accept_date(self, accept_date):
        """Sets the accept_date of this VaCloseRequestResponse.

        解約申込受付日<br>半角文字<br>解約申込を受け付けた日付を示します<br>YYYY-MM-DD形式<br>  # noqa: E501

        :param accept_date: The accept_date of this VaCloseRequestResponse.  # noqa: E501
        :type: str
        """
        if accept_date is None:
            raise ValueError("Invalid value for `accept_date`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VaCloseRequestResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VaCloseRequestResponse):
            return False
