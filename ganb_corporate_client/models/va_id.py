...
class VaId(object):
    ...
    def __init__(self, va_id=None):  # noqa: E501
        """VaId - a model defined in Swagger"""  # noqa: E501
        self._va_id = None
    ...
    @property
    def va_id(self):
        """Gets the va_id of this VaId.  # noqa: E501

        振込入金口座ID<br>半角数字<br>振込入金口座を識別するID<br>  # noqa: E501

        :return: The va_id of this VaId.  # noqa: E501
        :rtype: str
        """
        return self._va_id
    ...
    def va_id(self, va_id):
        """Sets the va_id of this VaId.

        振込入金口座ID<br>半角数字<br>振込入金口座を識別するID<br>  # noqa: E501

        :param va_id: The va_id of this VaId.  # noqa: E501
        :type: str
        """
        if va_id is None:
