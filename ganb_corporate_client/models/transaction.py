...
class Transaction(object):
    ...
    def transaction_type(self):
        ...
        入払コード<br>半角数字<br>・1=入金<br>・2=出金<br>  # noqa: E501
    ...
    def balance(self):
        ...
        取引後残高<br>半角数字　マイナス含む<br>  # noqa: E501
    ...
    def item_key(self):
        ...
        明細キー<br>半角数字<br>口座の科目が01=普通預金（有利息）または02=普通預金（決済用）の場合は口座ID毎に設定される明細キー（明細データtimestamp（μs））<br>該当データがない場合は項目自体を設定しません  # noqa: E501
