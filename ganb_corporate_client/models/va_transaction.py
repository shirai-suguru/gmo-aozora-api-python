...
class VaTransaction(object):
    ...
    def partner_name(self):
        ...
        サービス企業名<br>全半角文字<br>振込入金口座契約サービス企業名<br>  # noqa: E501
    ...
    def item_key(self):
        ...
        明細キー<br>半角数字<br>口座ID毎に設定される明細キー（明細データtimestamp（μs））  # noqa: E501
