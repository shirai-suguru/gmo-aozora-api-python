...
class TransferRequestResultResponse(object):
    ...
    def result_code(self):
        ...
        結果コード<br>半角数字<br>1:完了　2：未完了　8：期限切<br>  # noqa: E501
    ...
    def apply_end_datetime(self):
        ...
        振込依頼完了日時<br>半角文字<br>YYYY-MM-DDTHH:MM:SS+09:00形式<br>結果コードが、1:完了のときのみセット<br>振込申請番号の最も直近の依頼の完了日時を返却<br>それ以外は項目自体を設定しません<br>  # noqa: E501
