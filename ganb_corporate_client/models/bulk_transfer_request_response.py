...
class BulkTransferRequestResponse(object):
    ...
    def __init__(self, account_id=None, result_code=None, apply_no=None, apply_end_datetime=None):  # noqa: E501
        """BulkTransferRequestResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this BulkTransferRequestResponse.  # noqa: E501

        口座ID<br>半角英数字<br>口座を識別するID<br>  # noqa: E501

        :return: The account_id of this BulkTransferRequestResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this BulkTransferRequestResponse.

        口座ID<br>半角英数字<br>口座を識別するID<br>  # noqa: E501

        :param account_id: The account_id of this BulkTransferRequestResponse.  # noqa: E501
        :type: str
        """
    ...
    def result_code(self):
        """Gets the result_code of this BulkTransferRequestResponse.  # noqa: E501

        結果コード<br>半角数字<br>1:完了　2：未完了<br>  # noqa: E501

        :return: The result_code of this BulkTransferRequestResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def result_code(self, result_code):
        """Sets the result_code of this BulkTransferRequestResponse.

        結果コード<br>半角数字<br>1:完了　2：未完了<br>  # noqa: E501

        :param result_code: The result_code of this BulkTransferRequestResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def apply_no(self):
        """Gets the apply_no of this BulkTransferRequestResponse.  # noqa: E501

        受付番号（振込申請番号）<br>半角数字<br>すべての振込・総合振込で採番される、照会の基本単位となる番号<br>  # noqa: E501

        :return: The apply_no of this BulkTransferRequestResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def apply_no(self, apply_no):
        """Sets the apply_no of this BulkTransferRequestResponse.

        受付番号（振込申請番号）<br>半角数字<br>すべての振込・総合振込で採番される、照会の基本単位となる番号<br>  # noqa: E501

        :param apply_no: The apply_no of this BulkTransferRequestResponse.  # noqa: E501
        :type: str
        """
        if apply_no is None:
    ...
    def apply_end_datetime(self):
        """Gets the apply_end_datetime of this BulkTransferRequestResponse.  # noqa: E501

        振込依頼完了日時<br>半角文字<br>YYYY-MM-DDTHH:MM:SS+09:00形式<br>結果コードが、1:完了のときのみセット<br>それ以外は項目自体を設定しません<br>  # noqa: E501

        :return: The apply_end_datetime of this BulkTransferRequestResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def apply_end_datetime(self, apply_end_datetime):
        """Sets the apply_end_datetime of this BulkTransferRequestResponse.

        振込依頼完了日時<br>半角文字<br>YYYY-MM-DDTHH:MM:SS+09:00形式<br>結果コードが、1:完了のときのみセット<br>それ以外は項目自体を設定しません<br>  # noqa: E501

        :param apply_end_datetime: The apply_end_datetime of this BulkTransferRequestResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkTransferRequestResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkTransferRequestResponse):
            return False
