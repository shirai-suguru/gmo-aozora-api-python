...
class BulkTransferResponse(object):
    ...
    def transfer_designated_date(self):
        ...
        振込指定日<br>半角文字<br>YYYY-MM-DD形式<br>  # noqa: E501
    ...
    def bulk_transfer_infos(self):
        ...
        総合振込明細情報<br>総合振込明細のリスト<br>明細情報取得フラグが「True：取得する」、かつ明細情報取得結果フラグが「True：取得可」のときのみ設定します<br>それ以外は項目自体を設定しません<br>  # noqa: E501
